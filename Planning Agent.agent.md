...
## Acceptance Criteria
[Measurable pass/fail criteria from QA Lead]
...
1. **Backend/Database tasks first** — They produce the API endpoints others consume.
2. **Design tasks second** — They produce tokens that frontend/mobile need.
3. **Frontend and Mobile tasks third** — They consume endpoints and tokens.
